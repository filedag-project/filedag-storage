...
func NewIamApiServer(router *mux.Router, authSys *iam.AuthSys, stats *httpstatss.HTTPStats, cleanData func(accessKey string), bucketInfoFunc func(ctx context.Context, accessKey string) []store.BucketInfo) {
...
func (iamApi *iamApiServer) registerRouter(router *mux.Router, stats *httpstatss.HTTPStats) {
	// API Router
