...
type DagPool interface {
	Add(ctx context.Context, block blocks.Block, pin bool, user string, password string) error
	Get(ctx context.Context, c cid.Cid, pin bool, user string, password string) (blocks.Block, error)
	Remove(ctx context.Context, c cid.Cid, pin bool, user string, password string) error
