...
func (d *Pool) GetNode(ctx context.Context, c cid.Cid) (*dagnode.DagNode, error) {
	//todo mul node
...
func (d *Pool) UseNode(ctx context.Context, c cid.Cid) (*dagnode.DagNode, error) {
	//todo mul node
...
func (d *Pool) GetNodeUseIP(ctx context.Context, ip string) (*dagnode.DagNode, error) {
	//todo mul node
